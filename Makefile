...
BuildExeForLinux:
	...
	GOOD=linux GOARCH=amd64 go build -o $(fileName) -ldflags=" -X 'main.BuildVariableGCPAuthentication=false' -X 'main.BuildVariableUseServiceAccountForGuiTestCaseBuilderServer=true' -X 'main.BuildVariableUseServiceAccountForGuiExecutionServer=true' -X 'main.BuildVariableExecutionLocationForFenixGuiExecutionServer=GCP' -X 'main.BuildVariableFenixGuiExecutionServerAddress=fenixguiexecutionserver-must-be-logged-in-nwxrrpoxea-lz.a.run.app' -X 'main.BuildVariableFenixGuiExecutionServerPort=443' -X 'main.BuildVariableExecutionLocationForFenixGuiTestCaseBuilderServer=GCP' -X 'main.BuildVariableFenixGuiTestCaseBuilderServerAddress=fenixguitestcasebuilderserver-must-be-logged-in-nwxrrpoxea-lz.a.run.app' -X 'main.BuildVariableFenixGuiTestCaseBuilderServerPort=443' -X 'main.BuildVariableExecutionLocationForThisApplication=LOCALHOST_NODOCKER' -X 'main.BuildVariableFYNE_SCALE=0.6' -X 'main.BuildVariableRunAsTrayApplication=NO' -X 'main.BuildVariableApplicationGrpcPort=6668'" .

CrossBuildForWindows:
	$(eval fileName := $(filenamePartFirst)$(datetime)$(filenamePartLast))
	GOOS=windows GOARCH=amd64 CGO_ENABLED=1 CXX=x86_64-w64-mingw32-g++ CC=x86_64-w64-mingw32-gcc go build -o $(fileName) -ldflags=" -X 'main.BuildVariableGCPAuthentication=false' -X 'main.BuildVariableUseServiceAccountForGuiTestCaseBuilderServer=true' -X 'main.BuildVariableUseServiceAccountForGuiExecutionServer=true' -X 'main.BuildVariableExecutionLocationForFenixGuiExecutionServer=GCP' -X 'main.BuildVariableFenixGuiExecutionServerAddress=fenixguiexecutionserver-must-be-logged-in-nwxrrpoxea-lz.a.run.app' -X 'main.BuildVariableFenixGuiExecutionServerPort=443' -X 'main.BuildVariableExecutionLocationForFenixGuiTestCaseBuilderServer=GCP' -X 'main.BuildVariableFenixGuiTestCaseBuilderServerAddress=fenixguitestcasebuilderserver-must-be-logged-in-nwxrrpoxea-lz.a.run.app' -X 'main.BuildVariableFenixGuiTestCaseBuilderServerPort=443' -X 'main.BuildVariableExecutionLocationForThisApplication=LOCALHOST_NODOCKER' -X 'main.BuildVariableFYNE_SCALE=0.6' -X 'main.BuildVariableRunAsTrayApplication=NO' -X 'main.BuildVariableApplicationGrpcPort=6668'" .
