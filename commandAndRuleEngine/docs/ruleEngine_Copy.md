...
- External calls: `commandAndRuleEngine.executeCopyFullELementStructure`, `commandAndRuleEngine.verifyIfElementCanBeCopied`, `errors.New`, `fmt.Sprintf`
...
- External calls: `commandAndRuleEngine.verifyIfComponentCanBeCopiedSimpleRules`
