...
- External calls: `commandAndRuleEngine.verifyIfComponentCanBeSwappedSimpleRules`, `commandAndRuleEngine.verifyIfComponentCanBeSwappedWithComplexRules`, `errors.New`, `fmt.Sprintf`
