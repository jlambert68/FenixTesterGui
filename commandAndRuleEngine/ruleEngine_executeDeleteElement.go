...
func (commandAndRuleEngineObject *commandAndRuleEngineObjectStruct) executeTCRuleDeletion105(uuidToDelete string) (err error) {
	...
	*/
	...
	// Create new B10-bond element
	newB10oxBondElement := commandAndRuleEngineObject.createNewBondB10oxElement(parentElementUuid)

	// Add New Elements to Map
	commandAndRuleEngineObject.testcaseModel.TestCaseModelMap[newB10oxBondElement.MatureElementUuid] = newB10oxBondElement
...
func (commandAndRuleEngineObject *commandAndRuleEngineObjectStruct) executeTCRuleDeletion106(uuidToDelete string) (err error) {

	// Call shared delete function
	err = commandAndRuleEngineObject.executeTCRuleDeletion_106_107_108_109(uuidToDelete)
...
func (commandAndRuleEngineObject *commandAndRuleEngineObjectStruct) executeTCRuleDeletion107(uuidToDelete string) (err error) {
...
func (commandAndRuleEngineObject *commandAndRuleEngineObjectStruct) executeTCRuleDeletion108(uuidToDelete string) (err error) {
...
func (commandAndRuleEngineObject *commandAndRuleEngineObjectStruct) executeTCRuleDeletion109(uuidToDelete string) (err error) {
...
func (commandAndRuleEngineObject *commandAndRuleEngineObjectStruct) executeTCRuleDeletion_106_107_108_109(uuidToDelete string) (err error) {
	...
	*/
	...
	nextNextElement, existInMap := commandAndRuleEngineObject.testcaseModel.TestCaseModelMap[nextNextElementUuid]
	if existInMap == false {
		commandAndRuleEngineObject.logger.WithFields(logrus.Fields{
...
func (commandAndRuleEngineObject *commandAndRuleEngineObjectStruct) executeTCRuleDeletion110(uuidToDelete string) (err error) {

	// Call shared delete function
	err = commandAndRuleEngineObject.executeTCRuleDeletion_110_111_112_113(uuidToDelete)
...
func (commandAndRuleEngineObject *commandAndRuleEngineObjectStruct) executeTCRuleDeletion111(uuidToDelete string) (err error) {
...
func (commandAndRuleEngineObject *commandAndRuleEngineObjectStruct) executeTCRuleDeletion112(uuidToDelete string) (err error) {
...
func (commandAndRuleEngineObject *commandAndRuleEngineObjectStruct) executeTCRuleDeletion113(uuidToDelete string) (err error) {
...
func (commandAndRuleEngineObject *commandAndRuleEngineObjectStruct) executeTCRuleDeletion_110_111_112_113(uuidToDelete string) (err error) {
	...
	*/
	...
	previousPreviousElement, existInMap := commandAndRuleEngineObject.testcaseModel.TestCaseModelMap[previousPreviousElementUuid]
	if existInMap == false {
		commandAndRuleEngineObject.logger.WithFields(logrus.Fields{
...
func (commandAndRuleEngineObject *commandAndRuleEngineObjectStruct) executeTCRuleDeletion114(uuidToDelete string) (err error) {

	// Call shared delete function
	err = commandAndRuleEngineObject.executeTCRuleDeletion_114_115_116_117(uuidToDelete)
...
func (commandAndRuleEngineObject *commandAndRuleEngineObjectStruct) executeTCRuleDeletion115(uuidToDelete string) (err error) {
...
func (commandAndRuleEngineObject *commandAndRuleEngineObjectStruct) executeTCRuleDeletion116(uuidToDelete string) (err error) {
...
func (commandAndRuleEngineObject *commandAndRuleEngineObjectStruct) executeTCRuleDeletion117(uuidToDelete string) (err error) {
...
func (commandAndRuleEngineObject *commandAndRuleEngineObjectStruct) executeTCRuleDeletion_114_115_116_117(uuidToDelete string) (err error) {
	...
	*/
	...
	// Remove Old Elements from Map
	delete(commandAndRuleEngineObject.testcaseModel.TestCaseModelMap, elementToRemove.MatureElementUuid)
