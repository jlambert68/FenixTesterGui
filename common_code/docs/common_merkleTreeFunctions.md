...
- Selector calls: `merkleTree.Col`, `merkleTree.Filter`, `merkleTreeLeafNodes.Mutate`, `merkleTreeLeafNodes.Nrow`, `series.New`
...
- Exported: `true`
- Control-flow features: `if, for/range`
- Selector calls: `hash.Sum`, `hash.Write`, `hex.EncodeToString`, `sha256.New`, `sort.Strings`, `strconv.Itoa`
...
- Selector calls: `dataframe.HasHeader`, `dataframe.New`, `dataframe.ReadCSV`, `dataframe.Sort`, `dataframe.WithDelimiter`, `df.Arrange`, `df.Elem`, `df.Mutate`
...
- Selector calls: `dataframe.Sort`, `log.Fatalln`, `merkleTreeLeafNodes.Arrange`, `merkleTreeLeafNodes.Col`, `merkleTreeLeafNodes.Elem`, `merkleTreeLeafNodes.Filter`, `merkleTreeLeafNodes.Ncol`, `merkleTreeLeafNodes.Nrow`
...
- Selector calls: `dataframe.New`, `hash.Sum`, `hash.Write`, `hex.EncodeToString`, `merkleTreeDataFrame.RBind`, `series.New`, `sha256.New`, `sort.Strings`
...
- Selector calls: `dataFrameToWorkOn.Arrange`, `dataFrameToWorkOn.Col`, `dataFrameToWorkOn.Filter`, `dataframe.Sort`, `log.Fatalln`, `strings.HasSuffix`, `strings.Index`, `strings.LastIndex`
...
- Selector calls: `s.Records`, `s.Type`, `series.New`
