# detailedExecutionsModel_testcasesListModelForExecutions_variables.go

## File Overview
- Path: `executions/detailedExecutionsModel/detailedExecutionsModel_testcasesListModelForExecutions_variables.go`
...
- `DetailedExecutionsModelObjectStruct`
...
- `ChannelCommandFullDetailedExecutionsStatusUpdate`
...
- `MessageChannelMaxSizeDetailedExecutionStatus`
- `SubscriptionTableForTestCaseExecutionFinishedExecutionsTable`
- `SubscriptionTableForTestCaseExecutionOnQueueTable`
