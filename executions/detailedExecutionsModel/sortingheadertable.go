...
func NewSortingHeaderTable(tableOpts *TestCaseExecutionsSummaryTableOpts) *SortingHeaderTable {
...
func stringSort(tableOpts *TestCaseExecutionsSummaryTableOpts, col int) SortFn {
