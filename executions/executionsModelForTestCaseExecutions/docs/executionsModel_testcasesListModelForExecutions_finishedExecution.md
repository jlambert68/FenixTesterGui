...
- Selector calls: `fenixExecutionServerGuiGrpcApi.CurrentFenixExecutionGuiProtoFileVersionEnum`, `grpc_out_GuiExecutionServer.GetHighestFenixGuiExecutionServerProtoFileVersion`, `errors.New`, `fmt.Sprintf`, `fmt.Println`, `time.Now`, `strconv.Itoa`, `strconv.FormatBool`
