...
- Selector calls: `fmt.Fprintf`, `log.Fatalln`, `w.WriteHeader`

### RestAPIServer (method on `*RestApiStruct`)
- Signature: `func (*RestApiStruct) RestAPIServer()`
- Exported: `true`
- Control-flow features: `if`
- Selector calls: `http.Handle`, `http.ListenAndServe`, `log.Fatalln`, `log.Println`, `mux.NewRouter`, `router.HandleFunc`
...
- Exported: `true`
- Control-flow features: `if, defer`
- Selector calls: `json.Marshal`, `log.Fatalln`, `w.Header`, `w.Write`, `w.WriteHeader`
...
- Selector calls: `err.Error`, `fmt.Fprintf`, `json.Marshal`, `log.Fatalln`, `w.Header`, `w.Write`, `w.WriteHeader`
...
- Control-flow features: `if, defer`
- Internal calls: `extractAndValidateJsonBody`
- Selector calls: `err.Error`, `fenixGuiTestCaseBuilderServerGrpcApi.CurrentFenixTestCaseBuilderProtoFileVersionEnum`, `fmt.Fprintf`, `grpcOut.GetHighestFenixGuiTestCaseBuilderServerProtoFileVersion`, `json.Marshal`, `log.Fatalln`, `w.Header`, `w.Write`
