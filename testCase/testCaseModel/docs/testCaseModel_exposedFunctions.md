...
- External calls: `errors.New`, `fmt.Sprintf`, `strings.Index`, `testCaseModel.GenerateShortUuidFromFullUuid`, `testCaseModel.UpdateTreeViewModelForTestCase`, `testCaseModel.recursiveTextualTestCaseModelExtractor`
...
- External calls: `testCaseModel.GetTreeViewModelForTestCase`
...
- External calls: `errors.New`, `fmt.Sprintf`, `testCaseModel.generateUINameForTestCaseElement`
...
- External calls: `errors.New`, `fmt.Sprintf`, `testCaseModel.recursiveGraphicalTestCaseTreeModelExtractor`
...
- External calls: `errors.New`, `fmt.Sprintf`, `testCaseModel.recursiveZombieElementSearchInTestCaseModel`
