...
- Selector calls: `errors.New`, `fmt.Sprintf`, `testCaseModel.recursiveTextualTestCaseModelExtractor`, `testCaseModel.GenerateShortUuidFromFullUuid`, `strings.Index`, `testCaseModel.UpdateTreeViewModelForTestCase`
