...
- Selector calls: `errors.New`, `fmt.Println`, `fmt.Sprintf`, `log.Fatalln`
...
- Selector calls: `errors.New`, `fmt.Println`, `fmt.Sprintf`, `protojson.Format`, `sharedCode.HashValues`, `strings.ReplaceAll`
...
- Selector calls: `errors.New`, `file.Close`, `file.WriteString`, `fmt.Printf`, `fmt.Println`, `fmt.Sprint`, `fmt.Sprintf`, `os.OpenFile`
...
- Selector calls: `errors.New`, `fenixGuiTestCaseBuilderServerGrpcApi.MetaDataSelectTypeEnum`, `fmt.Println`, `fmt.Sprintf`, `log.Fatal`, `protojson.Format`, `sharedCode.HashSingleValue`, `strings.ReplaceAll`
...
- Doc: Convert the TestCaseTemplateFiles into its gRPC-version
- Internal calls: `string`
- Selector calls: `errors.New`, `fmt.Println`, `fmt.Sprintf`, `protojson.Format`, `sharedCode.HashSingleValue`, `strings.ReplaceAll`
...
- Selector calls: `errors.New`, `fenixGuiTestCaseBuilderServerGrpcApi.MetaDataSelectTypeEnum`, `fmt.Println`, `fmt.Sprintf`, `gRPCUserSpecifiedTestCaseMetaDataMessage.GetCurrentSelectedDomainUuid`, `log.Fatalln`, `sharedCode.HashValues`, `testCaseModel.verifyMandatoryFieldsForMetaData`
