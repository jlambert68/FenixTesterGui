...
- External calls: `autoFilterRadioGroup.SetSelected`, `container.NewHBox`, `listTestCaseUIObject.calculateMetaDataFilterFunction`, `listTestCaseUIObject.generateSimpleTestCaseMetaDataMainFilterContainer`, `newSimpleTestCaseMetaDataMainFilterContainer.Refresh`, `widget.NewButton`, `widget.NewRadioGroup`
...
- External calls: `canvas.NewRectangle`, `container.New`, `container.NewVBox`, `layout.NewFormLayout`, `layout.NewVBoxLayout`, `listTestCaseUIObject.calculateMetaDataFilterFunction`, `listTestCaseUIObject.generateSimpleTestCaseMetaDataMainFilterContainer`, `newSimpleTestCaseMetaDataMainFilterContainer.Refresh`
...
- External calls: `container.New`, `container.NewBorder`, `container.NewScroll`, `container.NewVBox`, `fmt.Sprintf`, `layout.NewGridLayout`, `listTestCaseUIObject.buildGUIFromMetaDataGroupsMap`, `testCaseModel.ConvertTestCaseMetaData`
