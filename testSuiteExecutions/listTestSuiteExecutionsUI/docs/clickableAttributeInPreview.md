...
## File Overview
- Path: `testSuiteExecutions/listTestSuiteExecutionsUI/clickableAttributeInPreview.go`
...
- Selector calls: `container.NewBorder`, `container.NewScroll`, `labelBorderContainer.Refresh`, `labelBorderContainer.Resize`, `labelScrollContainer.Refresh`, `labelScrollContainer.Resize`, `labelScrollContainer.SetMinSize`, `lbl.MinSize`
...
- Selector calls: `attributeMessageBorderContainer.Refresh`, `attributeMessageStringBuilder.String`, `attributeMessageStringBuilder.WriteString`, `c.LeftClicked`, `clipboard.SetContent`, `container.NewBorder`, `container.NewScroll`, `container.NewVBox`
...
- Signature: `func newClickableAttributeInPreview(attributeValue string, attributeName string, testInstructionName string, leftClicked func(), rightClicked func(), attributeType attributeTypeType, testCaseInstructionPreViewObject *TestSuiteInstructionPreViewStruct) *clickableAttributeInPreviewStruct`
- Exported: `false`
- Control-flow features: `none detected`
- Doc: Used for creating a new Attribute label
- Selector calls: `clickableAttributeInPreview.ExtendBaseWidget`, `time.Now`
