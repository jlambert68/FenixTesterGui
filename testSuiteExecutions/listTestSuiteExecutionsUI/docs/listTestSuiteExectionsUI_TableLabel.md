...
- Selector calls: `TestSuiteInstructionPreViewObject.GenerateTestSuiteExecutionPreviewContainer`, `fmt.Println`, `l.onDoubleTap`, `loadAllTestSuiteExecutionsForOneTestSuiteButtonReference.Enable`, `loadAllTestSuiteExecutionsForOneTestSuiteButtonReference.Refresh`, `testSuiteExecutionsListTable.Refresh`, `time.Now`, `time.Since`
