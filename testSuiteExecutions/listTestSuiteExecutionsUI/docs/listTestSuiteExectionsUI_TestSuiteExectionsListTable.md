...
- Selector calls: `testSuiteExecutionsModelRef.DeleteFromTestSuiteExecutionsMap`, `testSuiteExecutionsModel.TestSuiteExecutionUuidType`
...
- Internal calls: `newSortableHeaderLabel`, `updateTestSuiteExecutionsListTable`, `calculateAndSetCorrectColumnWidths`
...
- Selector calls: `updateTestSuiteExecutionsListTableMutex.Lock`, `updateTestSuiteExecutionsListTableMutex.Unlock`, `container.NewStack`, `canvas.NewRectangle`, `lbl.Show`, `alt.Hide`, `fyne.Do`, `lbl.SetText`
...
- Selector calls: `fyne.MeasureText`, `theme.TextSize`, `fyne.Do`, `testSuiteExecutionsListTable.SetColumnWidth`, `theme.Padding`, `testSuiteExecutionsListTable.Refresh`
...
- Selector calls: `loadTestSuiteExecutionListTableTableMutex.Lock`, `loadTestSuiteExecutionListTableTableMutex.Unlock`, `testSuiteExecutionsModelObject.ReadAllFromTestSuiteExecutionsMap`, `testSuiteExecutionsModelObject.GetAllTestSuiteExecutionsForOneTestSuiteUuid`, `testSuiteExecutionsModel.TestSuiteUuidType`, `fmt.Sprintf`, `tempTestSuiteExecution.GetDomainName`, `tempTestSuiteExecution.GetDomainUUID`
...
- Internal calls: `loadTestSuiteExecutionListTableTable`, `sort2DStringSlice`, `int`, `calculateAndSetCorrectColumnWidths`, `updateTestSuiteExecutionsListTable`
...
- Internal calls: `sortGuiTableOnColumn`, `uint8`, `sortGuiTableAscendingOnTestSuiteExecutionTimeStamp`
