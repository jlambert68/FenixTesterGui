...
- Selector calls: `listTestSuiteUIObject.calculateAndSetCorrectColumnWidths`, `listTestSuiteUIObject.loadTestSuiteListTableTable`, `listTestSuiteUIObject.updateTestSuitesListTable`
...
- Selector calls: `bytes.NewReader`, `listTestSuiteUIObject.calculateAndSetCorrectColumnWidths`, `listTestSuiteUIObject.updateTestSuitesListTable`, `png.Decode`, `widget.NewLabel`, `widget.NewTable`
...
- Selector calls: `boolbits.NewAllZerosEntry`, `err.Error`, `fmt.Sprintf`, `listTestSuiteUIObject.sort2DStringSlice`, `log.Fatalln`, `resultEntry.And`, `resultEntry.Equals`, `resultEntry.Or`
