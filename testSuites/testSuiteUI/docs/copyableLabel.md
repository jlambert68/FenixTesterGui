...
## File Overview
- Path: `testSuites/testSuiteUI/copyableLabel.go`
- Package: `testSuiteUI`
- Functions/Methods: `4`
- Imports: `5`
...
### newCopyableLabel
- Signature: `func newCopyableLabel(label string, isCopyable bool, testSuiteUiref *TestSuiteUiStruct) *copyableLabelStruct`
- Exported: `false`
- Control-flow features: `none detected`
