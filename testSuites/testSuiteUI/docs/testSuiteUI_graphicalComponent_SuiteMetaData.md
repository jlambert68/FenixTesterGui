...
- Selector calls: `container.NewVBox`, `widget.NewLabel`, `testSuitesModel.ConvertTestSuiteMetaData`, `testSuiteUiModel.buildGUIFromMetaDataGroupsMap`, `container.NewBorder`, `myContainer.MinSize`, `container.NewScroll`, `myContainerScroll.SetMinSize`
...
- Internal calls: `newCustomSelectComboBoxWidget`, `calcSelectWidth`, `newCustomAttributeCheckBoxGroupWidget`, `calcCheckGroupWidth`
- Selector calls: `log.Fatalln`, `testSuiteUiModel.convertMetaDataToNewMap`, `canvas.NewRectangle`, `widget.NewSelect`, `sel.SetSelected`, `sel.Disable`, `container.New`, `layout.NewGridWrapLayout`
