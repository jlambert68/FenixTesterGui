...
- External calls: `copier.CopyWithOption`, `err.Error`, `errors.New`, `fmt.Println`, `fmt.Sprintf`, `fyne.CurrentApp`, `log.Fatalln`, `sharedCode.HashValues`
...
- External calls: `fmt.Sprintf`, `sharedCode.HashSingleValue`, `sharedCode.HashValues`, `testCasesInTestSuiteMessage.GetDomainName`, `testCasesInTestSuiteMessage.GetDomainUuid`, `testCasesInTestSuiteMessage.GetTestCaseName`, `testCasesInTestSuiteMessage.GetTestCaseUuid`
...
- External calls: `protojson.Format`, `sharedCode.HashSingleValue`
...
- External calls: `sharedCode.HashSingleValue`
...
- External calls: `fenixGuiTestCaseBuilderServerGrpcApi.MetaDataSelectTypeEnum`, `fmt.Sprintf`, `log.Fatalln`, `sharedCode.HashSingleValue`, `sharedCode.HashValues`
...
- External calls: `fenixGuiTestCaseBuilderServerGrpcApi.MetaDataSelectTypeEnum`, `fmt.Sprintf`, `log.Fatal`, `testSuiteModel.GetCreatedDate`, `testSuiteModel.GetLastChangedByComputerLogin`, `testSuiteModel.GetLastChangedByGcpLogin`
...
- External calls: `protojson.Format`, `sharedCode.HashSingleValue`, `strings.ReplaceAll`
...
- Doc: Generates 'TestCasesInTestSuite' to be added to full gRPC-message
- Internal calls: `string`
- External calls: `fenixGuiTestCaseBuilderServerGrpcApi.TestSuiteTypeEnum`, `fmt.Sprintf`, `sharedCode.HashValues`
