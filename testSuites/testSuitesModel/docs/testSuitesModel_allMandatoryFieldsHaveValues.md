...
- External calls: `testSuiteModel.verifyMandatoryFieldsForMetaData`
...
- External calls: `fmt.Sprintf`, `log.Fatalln`, `testSuiteModel.generateMandatoryMetaDataFieldsMap`
